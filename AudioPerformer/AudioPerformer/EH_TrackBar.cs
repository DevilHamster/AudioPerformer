...
{
    public class EH_TrackBar: System.Windows.Forms.Control
    {
        /// <summary>
        /// 初始化
        /// </summary>
        ...
        #region Events
        //注册一个委托
        public delegate void ValueChangedEventHandler(object sender, EH_TrackBarEventArgs e);
        //为本控件注册一个事件，该事件在_value值被改动时触发，在Form1.cs中执行任务，对应代码在Form1.cs中定义
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
             ...
             *如果处于滑动条拖动状态，会时刻执行ValueUpdate函数更新立即重绘更新滑动条
             */
        ...
        private void ValueUpdate()
        {
            ...
            //触发事件ValueChanged
            ValueChanged?.Invoke(this, new EH_TrackBarEventArgs(_value));
        }
